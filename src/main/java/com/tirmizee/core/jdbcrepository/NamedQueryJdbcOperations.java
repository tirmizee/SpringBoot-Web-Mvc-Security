...
public interface NamedQueryJdbcOperations extends NamedParameterJdbcOperations {
	...
	<T> T namedQueryForObject(String queryName, Map<String, ?> paramMap, RowMapper<T> rowMapper) throws DataAccessException;
	...
	<T> Page<T> queryForPage(String query, Pageable pageable, Object[] args, Class<T> mappedClass) throws DataAccessException;
	
	<T> Page<T> queryForPage(String query, Pageable pageable, Map<String, ?> paramMap, Class<T> mappedClass) throws DataAccessException;
	
	<T> Page<T> queryForPage(String query, Pageable pageable, Map<String, ?> paramMap, RowMapper<T> rowMapper) throws DataAccessException;
